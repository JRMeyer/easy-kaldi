...
online_cmvn_config=config/online_cmvn.conf
...
all_feats="ark,s,cs:apply-cmvn-online --config=$online_cmvn_config"
all_feats="$all_feats $dir/global_cmvn.stats scp:$data/feats.scp ark:- |"
all_feats="$all_feats splice-feats $splice_opts ark:- ark:- |"
all_feats="$all_feats transform-feats $dir/final.mat ark:- ark:- |"

feats="ark,s,cs:apply-cmvn-online --config=$online_cmvn_config"
feats="$feats $dir/global_cmvn.stats scp:$sdata/JOB/feats.scp ark:- |"
feats="$feats splice-feats $splice_opts ark:- ark:- | transform-feats"
feats="$feats $dir/final.mat ark:- ark:- | subsample-feats --n=$subsample ark:- ark:- |"
...
# this speeds up the training passes.
if [ $stage -le -1 ]; then
