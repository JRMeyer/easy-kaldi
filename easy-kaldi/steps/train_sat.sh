...
case $feat_type in
    delta) sifeats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk"
           sifeats="$sifeats scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp"
           sifeats="$sifeats ark:- | add-deltas $delta_opts ark:- ark:- |";;
    lda) sifeats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk"
         sifeats="$sifeats scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp"
         sifeats="$sifeats ark:- | splice-feats $splice_opts ark:- ark:- |"
         sifeats="$sifeats transform-feats $alidir/final.mat ark:- ark:- |"
...
if [ -f $alidir/trans.1 ]; then
    ...
    feats="$sifeats transform-feats --utt2spk=ark:$sdata/JOB/utt2spk"
    feats="$feats ark,s,cs:$alidir/trans.JOB ark:- ark:- |"
